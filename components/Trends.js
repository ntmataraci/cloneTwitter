import trends from "../datas/trends"
...
const Trends = () => {
    ...
    return (
        ...
        <div className={style.main}>
            ...
            <div style={{fontWeight:"bolder",marginLeft:"0.5rem"}}>Trends For You</div>
...
{trends.map(item => {
    return (
<div key={item.id} className={style.row} style={{display:"flex",flexWrap:"wrap",justifyContent:"space-between"}}>
